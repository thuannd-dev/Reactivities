    ...
    : BaseActivityDto
{
    ...
    public BaseActivityValidator(Func<T, TDto> selector)
    {
        ...
        //Don't use directly DateTime.Now because the value will caculated just once when the validator is created
        //Above code is a solution to make sure that the current time is caculated each time the validation is performed
